...
export const DF_BASE_HELPER_DEFINITIONS: DFHelperTemplateDefinition[] = [
	...
	},
	{
		...
		codetemplateData: `'{"author":"NineOfGaming","name":"§b§lFunction §3» §brig.init.rigs","version":1,"code":""}'`,
	},
	{
		...
		description:
			'Spawns an instance of the rig at the specified location.\nYou can create an animation called "default" which will have its first frame used for the spawn pose.',
