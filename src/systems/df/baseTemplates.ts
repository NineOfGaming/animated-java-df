...
export const DF_BASE_HELPER_DEFINITIONS: DFHelperTemplateDefinition[] = [
	...
	},
	{
		...
		category: 'core',
		description: 'Updates locator, camera, and interaction transforms for the current animation tick.',
	...
	},
	{
		...
		category: 'interactions',
		description: 'Updates the stored location value for a rig interaction and teleports its entity.',
