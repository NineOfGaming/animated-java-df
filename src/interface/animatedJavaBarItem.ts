...
const DF_BASE_TEMPLATE_CATEGORY_DETAILS: DFBaseTemplateCategoryDetails[] = [
	...
	{
		category: 'variants',
		actionId: 'animated_java:action/df-base-templates-variants',
		icon: 'palette',
		nameKey: 'action.df_base_templates_variants.name',
		tooltipKey: 'action.df_base_templates_variants.tooltip',
		sectionKey: 'action.df_base_templates.tooltip.variants_section',
		groupNameKey: 'action.df_base_templates_variants_group.name',
	},
	{
		category: 'locators',
		actionId: 'animated_java:action/df-base-templates-locators',
		icon: 'place',
		nameKey: 'action.df_base_templates_locators.name',
		tooltipKey: 'action.df_base_templates_locators.tooltip',
		sectionKey: 'action.df_base_templates.tooltip.locators_section',
		groupNameKey: 'action.df_base_templates_locators_group.name',
	},
	{
		category: 'cameras',
		actionId: 'animated_java:action/df-base-templates-cameras',
		icon: 'videocam',
		nameKey: 'action.df_base_templates_cameras.name',
		tooltipKey: 'action.df_base_templates_cameras.tooltip',
		sectionKey: 'action.df_base_templates.tooltip.cameras_section',
	...
	},
	{
		...
		icon: 'extension',
		nameKey: 'action.df_base_templates_offsets.name',
		tooltipKey: 'action.df_base_templates_offsets.tooltip',
		sectionKey: 'action.df_base_templates.tooltip.offsets_section',
		groupNameKey: 'action.df_base_templates_offsets_group.name',
	},
]
